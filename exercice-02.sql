...
SELECT * FROM `tag` WHERE name = 'Terminal BASH'; 
...
WHERE lastname = 'Lacombe' AND firstname = 'Arthur'

-- Exo 2.8
-- Supprimez toutes les relations entre un student et ses tags :
-- - student : Odette Thomas
SELECT * FROM `student` WHERE lastname = 'Thomas' AND firstname = 'Odette'; 
...
SELECT * FROM `project` WHERE name = "Ut delectus explicabo."; 
SELECT * FROM `student` WHERE project_id = 16; 
UPDATE `student` SET `project_id`= NULL
WHERE project_id = 16
