...
SELECT * FROM `student` WHERE `created_at` < '2021-01-01' AND  > '2021-01-10' 
...
SELECT * FROM `student` WHERE `start_date` < '2021-01-01' AND  > '2021-01-10' 
...
SELECT * FROM `student` WHERE `email` LIKE '%.fr' AND created_at <= '2021-01-10' OR `project_id` IS NULL; 